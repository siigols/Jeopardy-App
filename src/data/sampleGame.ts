    ...
    },
    {
      ...
      tiles: [
        ...
        { points: 600, answered: false, content: { type: 'simple', question: 'Denne Disney-filmen handler om en jente med magisk hår som heter Rapunzel.', answer: 'Hva er Flukten fra tårnet?' } },
        {
          ...
          content: {
            type: 'tenable',
            prompt: 'Topp 10 mest folkerike land i verden (størst først)',
            items: [
              'India',
              'Kina',
              'USA',
    ...
    },
    {
      ...
      tiles: [
        ...
        { points: 1000, answered: false, content: {
          ...
          metric: 'Høyde',
          items: [
            { image: 'https://placehold.co/300x400/2d2d3a/f0f0f8?text=185cm', label: 'Referanse', value: '185 cm', numericValue: 185 },
            { image: 'https://placehold.co/300x400/2d2d3a/f0f0f8?text=Messi', label: 'Lionel Messi', value: '170 cm', numericValue: 170 },
            { image: 'https://placehold.co/300x400/2d2d3a/f0f0f8?text=LeBron', label: 'LeBron James', value: '206 cm', numericValue: 206 },
            { image: 'https://placehold.co/300x400/2d2d3a/f0f0f8?text=Haaland', label: 'Erling Haaland', value: '194 cm', numericValue: 194 },
            { image: 'https://placehold.co/300x400/2d2d3a/f0f0f8?text=Simone', label: 'Simone Biles', value: '142 cm', numericValue: 142 },
            { image: 'https://placehold.co/300x400/2d2d3a/f0f0f8?text=Bolt', label: 'Usain Bolt', value: '195 cm', numericValue: 195 },
          ],
        } },
      ],
    },
